...
public:
  ...
  /// Start the background image publication thread, if enabled
  void start_image_publisher_thread();

  /// Stop the background image publication thread
  void stop_image_publisher_thread();
  ...
  void callback_monocular_unique(sensor_msgs::msg::Image::UniquePtr msg0, int cam_id0);
  ...
  void callback_stereo(const sensor_msgs::msg::Image::ConstSharedPtr msg0, const sensor_msgs::msg::Image::ConstSharedPtr msg1, int cam_id0,
                       int cam_id1);
  void callback_stereo_unique(sensor_msgs::msg::Image::UniquePtr msg0, sensor_msgs::msg::Image::UniquePtr msg1, int cam_id0, int cam_id1);
...
protected:
  ...
  std::atomic<bool> image_thread_running{false};
